...
<?php
    if(isset($_SESSION["login2"])){
       ...
       <a class="ti-user" style="color:#ffffff; margin-right: 20px;margin-left: -30px;" href="coachProfile.php"></a>
        </div>';       
    }
?>
...
<div class="container emp-profile">
            <!-- <form method="post" id="myform1"> -->
                       ...
                       <div class="profile-head"> 
                        <br><br>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="https://fitfy.000webhostapp.com/user_profile/coachProfile.php" role="tab" aria-controls="home" aria-selected="true">Personal Information</a>
                                </li>
                                <!--<li class="nav-item">
                ...
                <div class="col-md-2">
                     <button class="profile-edit-btn"id="edit" type="button" name="btnAddMore" value="Edit Profile"  onclick="editInfo()" style="margin-left: 355px; margin-top:125px;width: 100px;color: blue;">Edit Profile</button>
                    </div>
                    <!-- <div class="col-md-2">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <form action="uploadPhoto.php" method="post" enctype="multipart/form-data" id="myform">
                            <div class="profile-img">
                                
                                  <?php
                                    if(isset($_SESSION["u_photo"])){
                                       echo '<img src="'.$_SESSION["u_photo"].'" alt="" id="photo" name ="photo" style="height:193px">';       
                                    }
                                  ?>
                                 <!-- <input type="file" name="file" id="file" style="display: nonw;"> -->
                                <div class="file btn btn-lg btn-primary" id="change_photo">
                                    Change Photo
                                   <input type='file' name="file" id="file" onchange="readURL(this);" />
                                </div>
                            </div>
                                <button type="submit" class="profile-edit-btn" id="editPhoto" style="margin-left: 15px; margin-top:65px;width: 100px;color:#FF7F50;display: none;">Save Photo</button>
                        </form>
                        <img src="data.svg" alt="User browsing" style="margin-top: 72px;width: 300px;     height: 200px;">
                                ...
                                <p id="errors" style="font-size: 13px; color: red;"></p>
                                       <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p><textarea class="disabled" type="text" id="description" style="width: 300px;height: 100px;" value=""disabled> <?php echo $_SESSION['u_description'];?></textarea></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <p><input class="disabled" type="url" id="instagram" style="width:300px;" value="<?php echo $_SESSION['u_instagram'];?>"disabled></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <p><input class="disabled" type="text" id="specialism" value="<?php echo $_SESSION['u_specialism'];?>"disabled></p>
                                            </div>
                                        </div>
                                         <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                     <button class="profile-edit-btn" name="btnAddMore" value=" Log Out "/ style="margin-left: 525px;width: 100px;color: purple;"> <a href="logout2.php" style="color: purple; text-decoration: none;">Log Out</a></button>
                    </div>
                </form>
                            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width: 600px;">
      ...
      <div class="modal-footer">
        <a type="button" class="btn btn-default" data-dismiss="modal" style="margin-right: 244px;background-color: #2d276c; color: white;" href="logout2.php" >OK</a>
      </div>
    </div>
  </div>
</div>
